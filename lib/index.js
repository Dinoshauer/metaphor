...
exports.Engine = class {
    ...
    describeHtml(html, url, callback) {
        return exports.parse(html, url, this.settings, (description) => this._preview(description, callback));
    }
...
exports.parse = function (document, url, options, next) {
    ...
    Tags.parse(document, url, (tags, oembedLink) => {
        ...
        Oembed.describe(url, oembedLink, options, (oembed) => {
            ...
            description.url = url || description.url || oembed.url;
